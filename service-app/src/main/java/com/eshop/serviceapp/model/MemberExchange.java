...
public class MemberExchange extends BaseModel {
    private Integer memberExchangeId;
    ...
    public Integer getMemberExchangeId() {
        return memberExchangeId;
    }

    public void setMemberExchangeId(Integer memberExchangeId) {
        this.memberExchangeId = memberExchangeId;
    }
